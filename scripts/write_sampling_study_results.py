...
def main(method):
    # in results/weightlearning/{}/sampling_study write
    ...
    path = '{}/../results/weightlearning/{}/sampling_study'.format(dirname, method)
    ...
    for dataset in datasets:
        ...
        path = '{}/../results/weightlearning/{}/sampling_study/{}'.format(dirname, method, dataset)
        ...
        for wl_method in wl_methods:
            ...
            path = '{}/../results/weightlearning/{}/sampling_study/{}/{}'.format(dirname, method, dataset, wl_method)
            ...
            for evaluator in evaluators:
                ...
                path = '{}/../results/weightlearning/{}/sampling_study/{}/{}/{}'.format(dirname, method, dataset,
                                                                                        wl_method, evaluator)
                alphas = [alpha for alpha in os.listdir(path) if os.path.isdir(os.path.join(path, alpha))]
                ...
                for alpha in alphas:
                    ...
                    performance_series = calculate_experiment_performance(dataset, wl_method, evaluator, alpha, folds)
                    ...
                    timing_series = calculate_experiment_timing(dataset, wl_method, evaluator, alpha, folds)
    ...
    performance_frame.to_csv(
        '{}/../results/weightlearning/{}/sampling_study/{}_performance.csv'.format(dirname, method, method),
        index=False)
    timing_frame.to_csv(
        '{}/../results/weightlearning/{}/sampling_study/{}_timing.csv'.format(dirname, method, method),
        index=False)


def calculate_experiment_timing(dataset, wl_method, evaluator, alpha, folds):
    dirname = os.path.dirname(__file__)
...
def calculate_experiment_performance(dataset, wl_method, evaluator, alpha, folds):
    ...
    performance_series['Alpha'] = alpha
